...
| 6 - Postlexical rules | DONE | (uncommitted) | Added postlexical phase + rules (`the_prevocalic_reduction`, `t_flapping`), DX inventory target, and `test/g2p-postlexical.test.ts` (7/7). |
