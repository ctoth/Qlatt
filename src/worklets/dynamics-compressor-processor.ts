...
class DynamicsCompressorProcessor extends AudioWorkletProcessor {
  ...
  static get parameterDescriptors(): AudioParamDescriptor[] {
    return [
      { name: "threshold", defaultValue: -24, minValue: -100, maxValue: 0, automationRate: "k-rate" as const },
      { name: "knee", defaultValue: 12, minValue: 0, maxValue: 40, automationRate: "k-rate" as const },
      { name: "ratio", defaultValue: 12, minValue: 1, maxValue: 20, automationRate: "k-rate" as const },
      { name: "attack", defaultValue: 0.003, minValue: 0, maxValue: 1, automationRate: "k-rate" as const },
      { name: "release", defaultValue: 0.1, minValue: 0, maxValue: 1, automationRate: "k-rate" as const },
