...
- [Joint-Sequence Models for Grapheme-to-Phoneme Conversion](../Bisani_2008_Joint-sequenceModelsGrapheme-to-phonemeConversion/notes.md) — Strong. Direct methodological contrast: Elovitz's 329 hand-written context-sensitive rules (90% accuracy) versus Bisani's fully data-driven joint-sequence M-gram model trained by discounted EM; the pair spans the full range from manual rule engineering to statistical estimation for the same G2P task.
