...
- [[Murray_1993_SimulationEmotionSyntheticSpeech]] — Comprehensive review synthesizing decades of emotion-acoustic studies into Table I mapping five primary emotions to parameter changes. Murray provides qualitative parameter directions (e.g., anger = "much higher" pitch) while Banse provides the quantitative 29-parameter measurements across 14 emotions that make Murray's qualitative descriptions precise and implementable.
