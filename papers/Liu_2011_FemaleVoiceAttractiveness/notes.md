...
- [[Quene_2021_PitchTempoAttractiveness]] — Quene studies male voice attractiveness via F0 and tempo manipulation; together with Liu's female voice study, the two papers suggest attractiveness operates through different acoustic channels for male voices (F0, tempo) vs. female voices (breathiness, formant spacing). (Moderate)
- [[HodgesSimeon_2010_DominanceAttractiveness]] — Hodges-Simeon shows male voice attractiveness is predicted by low F0, high intensity, and low formant dispersion (Df), while dominance is predicted by low F0-SD; Liu focuses on female voice attractiveness through voice quality (breathiness), together revealing that attractiveness operates through different parameters for male vs female voices
