...
- [The role of f0 and formant frequencies in distinguishing the voices of men and women](../Hillenbrand_2009_RoleF0FormantFrequencies/notes.md) - Hillenbrand & Clark test the same uniform-scaling assumption Barreda validates here, but for speaker-sex judgments rather than speaker-size judgments; together the two papers bound how far frequency-only scaling can carry perceived speaker attributes (Strong)
- [The interaction of glottal-pulse rate and vocal-tract length in judgements of speaker size, sex, and age](../Smith_2005_InteractionGlottal-pulseRateVocal-tract/notes.md) - Smith & Patterson show glottal-pulse rate (F0) and vocal-tract length interact for size/sex/age judgments; Barreda isolates the formant-only (VTL) contribution to size judgments in the absence of F0 manipulation, separating which part of the size percept survives formant-only cues versus requiring the F0 x VTL interaction (Strong)
