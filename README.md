...
- The frontend runtime is declarative-first: `src/declarative-frontend/rule-pack.js` + `src/declarative-frontend/engine.js` drive structural, duration, prosody, and finalize phases.
