...
class AerodynamicModelProcessor extends AudioWorkletProcessor {
    ...
    process(_inputs, outputs, parameters) {
        ...
        this.wasm.aerodynamic_model_process(this.state, this.paramBuffers.enable.ptr, enableLen, this.paramBuffers.ag.ptr, agLen, this.paramBuffers.ac.ptr, acLen, this.paramBuffers.an.ptr, anLen, this.paramBuffers.st.ptr, stLen, this.paramBuffers.pm.ptr, pmLen, this.paramBuffers.ps.ptr, psLen, this.voicingBuffer.ptr, this.aspirationBuffer.ptr, this.fricationBuffer.ptr, this.b1Buffer.ptr, this.fnpBuffer.ptr, this.fnzBuffer.ptr, this.oqBuffer.ptr, this.tlBuffer.ptr, blockSize);
