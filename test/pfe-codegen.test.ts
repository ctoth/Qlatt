...
import { dbToLinear, resonatorMagnitudeDb } from "../src/builtin-functions";
...
describe("generatePfeRules", () => {
  ...
  it("evaluating generated rules produces identical values to imperative loop (within 1e-10)", () => {
    ...
    for (let i = 0; i < formants.length; i++) {
      ...
      imperativeResults[`a${idx}Linear`] =
        sign * dbToLinear(ampDb + correctionDb + ndbScaleVal) * parallelScale;
    }
