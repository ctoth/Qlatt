...
- [Boersma (1991) — Synthesis of Speech Sounds from a Multi-Mass Model of the Lungs, Vocal Tract, and Glottis](../Boersma_1991_MultiMassSpeechSynthesis/notes.md) — both address frication from first-principles aerodynamics rather than a fixed noise-source rule; Badin's measured aerodynamic/acoustic fricative data is exactly the kind of empirical target Boersma's turbulence-noise and constriction-flow equations would need to be validated against (Strong)
