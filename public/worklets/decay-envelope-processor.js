...
class DecayEnvelopeProcessor extends AudioWorkletProcessor {
    ...
    process(inputs, outputs, parameters) {
        ...
        // Process
        this.wasm.decay_envelope_process(this.state, this.triggerBuffer.ptr, trigger.length, this.amplitudeBuffer.ptr, amplitude.length, this.decayBuffer.ptr, 1, this.outputBuffer.ptr, blockSize);
        // Copy output
