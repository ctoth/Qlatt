...
- [11] Coker (1976) - Articulatory dynamics model → NOW IN COLLECTION: [Coker (1976) — A Model of Articulatory Dynamics and Control](../Coker_1976_ArticulatoryDynamicsControl/notes.md)
...
- [[Allen_1987_MITalk_TTS]] -- referenced; MITalk's morph dictionary approach contrasted with Delta's rule-based approach
- [[Carlson_1979_VowelPerceptionSalience]]
- [[Elovitz_1976_NRL_LTS]] -- cited as foundational letter-to-sound rules
- [[Hertz_1982_SRS_TextToSpeech]] -- cited as predecessor system that Delta improves upon
- [[Klatt_1979_SpeechPerceptionLexicalAccess]]
- [[Klatt_1982_KlattalkTTS]] -- cited as competing TTS system
- [[Pierrehumbert_1980_EnglishIntonation]] -- cited (via Pierrehumbert 1981) for target-and-transition intonation model

### Cited By (in Collection)
- [[Allen_1987_MITalk_TTS]] -- references Delta for duration rules and phonetic component improvements
- [[Carlson_1995_ModelsOfSpeechSynthesis]] -- cites Delta in survey of synthesis models
- [[Elovitz_1976_NRL_LTS]] -- references Delta as a more sophisticated rule development environment
- [[Hertz_1987_DeltaNonLinearPhonology]] -- extends Delta with non-linear phonology applications
- [[Hertz_1991_StreamsPhonesTransitions]] -- builds on Delta's multi-stream architecture
- [[Liberman_Mattingly_1985_MotorTheory]] -- references Delta for text-to-phoneme conversion
...
- **Pierrehumbert 1981 [24], Anderson et al. 1984 [25]**: Foundational intonation synthesis work showing how f0 contours can be generated by rule
- **Fujisaki & Hirose 1982 [28]**: Alternative quantitative approach to prosody modeling using mathematical functions rather than phonological targets

### Now in Collection (previously listed as leads)
- [Coker (1976) — A Model of Articulatory Dynamics and Control](../Coker_1976_ArticulatoryDynamicsControl/notes.md) - listed in "Related Work Worth Reading" under Synthesis Approaches as [11]. Coker's system is articulatory-dynamics synthesis (a spatial vocal-tract model driven by a mode-oriented linear dynamics model with a per-articulator lead/lag "priority" timing mechanism), a different synthesis strategy from Delta's rule-compiler architecture, but both address the same coarticulation-timing problem: Coker with explicit numeric priorities per phoneme per articulator, Delta with compiled phonological rules.

### Conceptual Links (not citation-based)
- [[Fujisaki_InformationProsodyModeling]] -- Moderate. Delta cites Fujisaki & Hirose 1982 as an alternative F0 modeling approach using interacting mathematical functions; Fujisaki's superposition model represents a fundamentally different philosophy from Pierrehumbert's target-and-transition model that Delta also supports.
