...
- [Vocal Tract Wall Effects, Losses, and Resonance Bandwidths](../Fant_1972_VocalTractWallEffectsBandwidths/notes.md) - (Strong) this paper's 100 Hz flat half-power bandwidth assumption for all resonances is only roughly valid in the mid-frequency range; Fant's decomposition into wall/friction/heat-conduction/radiation terms shows why it breaks down at low F1 (wall-dominated, exceeding 150 Hz near $F_W$) and high F3 (radiation-dominated, e.g. +190 Hz for [e]).
