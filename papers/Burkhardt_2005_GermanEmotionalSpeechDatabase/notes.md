...
- [Emotional Speech Synthesis: A Review](../Schroder_2001_EmotionalSpeechSynthesisReview/notes.md) - (Moderate) this review surveys the field via Burkhardt's PhD thesis and workshop paper (refs [8],[9], the Burkhardt & Sendlmeier 2000 paper listed above as a New Lead), the joy/fear formant-synthesis rule sets it tabulates; this later corpus paper's EMO-DB became the standard training/evaluation corpus for the emotional-speech field the review surveys.
